## Zooplankton stacked bar plots per lake ## =========================
...
Zoop.carp$YEAR = substr(Zoop.carp$SAMPLE.ID, 2,3)
...
carp.zoop.biomass$lake[carp.zoop.biomass$lake == '012'] <- 'Blue'
carp.zoop.biomass$lake[carp.zoop.biomass$lake == '019'] <- 'Center' 
carp.zoop.biomass$lake[carp.zoop.biomass$lake == '036'] <- 'Five.Island' 
carp.zoop.biomass$lake[carp.zoop.biomass$lake == '090'] <- 'North.Twin'
carp.zoop.biomass$lake[carp.zoop.biomass$lake == '105'] <- 'Silver'
carp.zoop.biomass$lake[carp.zoop.biomass$lake == '113'] <- 'Storm'
carp.zoop.biomass$lake[carp.zoop.biomass$lake == '406'] <- 'South.Twin'
carp.zoop.biomass$lake = as.factor(carp.zoop.biomass$lake)
levels(carp.zoop.biomass$lake) = c(levels(carp.zoop.biomass$lake), 'Blue','Center', 
                                   'Five.Island', 'North.Twin', 
                                   'Silver', 'Storm', 'South.Twin')
carp.zoop.biomass

# Add ALM Biomass data #=============================