...
# Carp 
plot(slp_change ~ carp_harv, data = slop_harv_spsu, cex = 1.5, pch = 19, ylim = c(-0.3, 0.2), col.axis = transparent,
     ylab = '|Change in slope|', xlab = 'Fish Harvested (kg/ha)', col = carp)
mod1 = lm(slp_change ~ carp_harv, data = slop_harv_spsu)
axis(side = 2, at = c(-0.2, -0.1, 0, 0.1, 0.2), labels = T, tick = F)
summary(mod1)
...
plot(slp_change ~ buff_harv, data = slop_harv_spsu, cex = 1.5, pch = 19, col = buffalo, ylim = c(-0.3, 0.2), col.axis = transparent,
     ylab = '|Change in slope|', xlab = 'Fish Harvested (kg/ha)')
mod2 = lm(slp_change ~ buff_harv, data = slop_harv_spsu)
summary(mod2)
abline(mod2, col = 'gray80', lty = 2)
...
chng_spsu$year = c(rep('2019', 7), rep('2020', 14))
chng_spsu = chng_spsu %>% mutate(year = as.double(year))
...
slps
slop_harv_spsu = left_join(slps, cumulative, by = c('year', 'lake'))
slop_harv_spsu
...
max(slop_harv_spsu$slope.value)
min(slop_harv_spsu$slope.value)

max(slop_harv_spsu$carp_harv)
min(slop_harv_spsu$carp_harv)

max(slop_harv_spsu$buff_harv)
min(slop_harv_spsu$buff_harv)

# Slope 
plot(slope.value ~ carp_harv, data = slop_harv_spsu, cex = 1.5, pch = 19, ylim = c(-0.35, -0.76), xlim = c(-5, 100),
     ylab = 'Size Spectra Slope', xlab = 'Fish Harvested (kg/ha)', col = carp)
mod1 = lm(slope.value ~ carp_harv, data = slop_harv_spsu)
summary(mod1)
abline(mod1, col = carp)
...
plot(slope.value ~ buff_harv, data = slop_harv_spsu, cex = 1.5, pch = 19, ylim = c(-0.35, -0.76), xlim = c(-5, 700),
     ylab = '', xlab = '', col = buffalo)
mod2 = lm(slope.value ~ buff_harv, data = slop_harv_spsu)
summary(mod2)
...
slop_harv_spsu2 = left_join(slps, fish_harv, by = c('lake', 'year'))
slop_harv_spsu2
...
max(slop_harv_spsu2$slope.value)
min(slop_harv_spsu2$slope.value)

max(slop_harv_spsu2$carp_harv)
min(slop_harv_spsu2$carp_harv)

max(slop_harv_spsu2$buff_harv)
min(slop_harv_spsu2$buff_harv)

# Slope 
plot(slope.value ~ carp_harv, data = slop_harv_spsu2, cex = 1.5, pch = 19, ylim = c(-0.35, -0.76), xlim = c(-5, 90),
     ylab = 'Size Spectra Slope', xlab = 'Fish Harvested (kg/ha)', col = carp)
mod1 = lm(slope.value ~ carp_harv, data = slop_harv_spsu2)
summary(mod1)
abline(mod1, col = carp)
...
plot(slope.value ~ buff_harv, data = slop_harv_spsu2, cex = 1.5, pch = 19, ylim = c(-0.35, -0.76), xlim = c(-5, 400),
     ylab = '', xlab = '', col = buffalo)
mod2 = lm(slope.value ~ buff_harv, data = slop_harv_spsu2)
summary(mod2)
abline(mod2, col = buffalo)
...
slop_harv_spsu = left_join(chng_spsu, fish_harv, by = c('year', 'lake'))
slop_harv_spsu
...
# Carp 
plot(slp_change ~ carp_harv, data = slop_harv_spsu, cex = 1.5, pch = 19, ylim = c(-0.3, 0.2),
     ylab = '|Change in slope|', xlab = 'Fish Harvested (kg/ha)', col = carp)
mod1 = lm(slp_change ~ carp_harv, data = slop_harv_spsu)
axis(side = 2, at = c(-0.2, -0.1, 0, 0.1, 0.2), labels = T, tick = F)
summary(mod1)
...
plot(slp_change ~ buff_harv, data = slop_harv_spsu, cex = 1.5, pch = 19, col = buffalo, ylim = c(-0.3, 0.2),
     ylab = '|Change in slope|', xlab = 'Fish Harvested (kg/ha)')
mod2 = lm(slp_change ~ buff_harv, data = slop_harv_spsu)
summary(mod2)
abline(mod2, col = 'gray80', lty = 2)
